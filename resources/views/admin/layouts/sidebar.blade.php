<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
            <!-- <div class="d-flex align-items-center">
                    ...
                    <div class="d-block">
                        ...
                        <a href="../../admin/pages/examples/sign-in.html" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{asset('/admin/assets/img/favicon/favicon-32x32.png')}}" height="20" width="20" alt="Volt Logo">
                    </span>
            ...
            <li class="nav-item {{ Route::is('models') ? 'active' : '' }}">
            ...
            <li class="nav-item {{ Route::is('registartion') ? 'active' : '' }}">
