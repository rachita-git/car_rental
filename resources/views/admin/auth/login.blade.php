                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="{{ asset('/admin/assets/img/illustrations/signin.svg')}}">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            @endif
                            <form action="{{ route('login_auth') }}" class="mt-4" method="post">
                                @csrf
                                <!-- Form -->
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-outline-secondary" type="button" onclick="togglePasswordVisibility()">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" id="eye-icon">
                                                    <!-- Open eye (visible when password is hidden) -->
                                                    <g id="eye-open">
                                                        <path fill="none" stroke="#9CA3AF" stroke-width="1.5" d="M12 6c3.8 0 7 4 7 6s-3.2 6-7 6-7-4-7-6 3.2-6 7-6z" />
                                                        <circle cx="12" cy="12" r="2.5" fill="#9CA3AF" />
                                                    </g>
                                                    <!-- Closed eye (visible when password is shown) -->
                                                    <g id="eye-closed" opacity="0">
                                                        <path fill="none" stroke="#9CA3AF" stroke-width="1.5" d="M12 6c3.8 0 7 4 7 6s-3.2 6-7 6-7-4-7-6 3.2-6 7-6z" />
                                                        <path stroke="#9CA3AF" stroke-width="1.5" stroke-linecap="round" d="M6 6l12 12" />
                                                    </g>
                                                </svg>
                                            </button>
                                        </div>
