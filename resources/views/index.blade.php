...
<header class="header slider-fade">
    <div class="owl-carousel owl-theme">
        <div class="item bg-img" data-overlay-dark="5" data-background="{{ asset('img/slider/11.jpg')}}">
            
        </div>
        <div class="item bg-img" data-overlay-dark="5" data-background="{{ asset('img/slider/12.jpg')}}">
            
        </div>
        <div class="item bg-img" data-overlay-dark="5" data-background="{{ asset('img/slider/14.jpg')}}">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 mb-30">
                <div class="content">
                    ...
                    </ul> <a href="{{route('about_us')}}" class="button-4">Read More <span class="ti-arrow-top-right"></span></a>
                </div>
            </div>
            <div class="col-lg-5 offset-lg-1 col-md-12">
                <div class="item"> <img src="{{ asset('img/about.jpg')}}" class="img-fluid" alt="">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center mb-30">
                ...
                <div class="section-title">Available<span>Cars</span></div>
            </div>
        </div>
        <div class="cars1-carousel owl-theme owl-carousel">
            @foreach($cars as $car)
            <div class="item">
                <div class="img"> <img src="{{ asset('/car/'.$car->image) }}" alt="" class="img_size"> </div>
                <div class="con opacity-1">
                    <div class="row d-flex align-items-center">
                        <div class="col-md-4">
                            <div class="title">
                                <a href="#">{{ $car->model->name }}</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="book">
                                <div>
                                    <span class="price">RS {{ number_format($car->price_per_day, 2) }}</span>
                                    <span>/day</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 text-end">
                            ...
                            <a data-bs-toggle="modal"
                                ...
                                href="#0"
                                class="button-2 mt-15 mb-15 rent_now_btn"
                                data-car-id="{{ $car->id }}">
                                Rent Now <span class="ti-arrow-top-right"></span>
                            </a>
                            @else
                            <a class="btn btn-secondary mt-15 mb-15" disabled>
                                Booked <span class="ti-arrow-top-right"></span>
                            </a>
                            @endif
                        </div>
                    </div>
...
<section class="car-types1 section-padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel owl-theme">
                    <div class="item"> <img src="{{ asset('img/cars/03.jpg')}}" class="img-fluid" alt="">
                        <div class="title">
                            <h4>Luxury Cars</h4>
                        </div>
                        <div class="curv-butn icon-bg">
                    ...
                    <div class="item"> <img src="{{ asset('img/cars/04.jpg')}}" class="img-fluid" alt="">
                        <div class="title">
                            <h4>Sport Cars</h4>
                        </div>
                        <div class="curv-butn icon-bg">
                    ...
                    <div class="item"> <img src="{{ asset('img/cars/02.jpg')}}" class="img-fluid" alt="">
                        <div class="title">
                            <h4>SUV</h4>
                        </div>
                        <div class="curv-butn icon-bg">
                    ...
                    <div class="item"> <img src="{{ asset('img/cars/01.jpg')}}" class="img-fluid" alt="">
                        <div class="title">
                            <h4>Convertible</h4>
                        </div>
                        <div class="curv-butn icon-bg">
                    ...
                    <div class="item"> <img src="{{ asset('img/cars/05.jpg')}}" class="img-fluid" alt="">
                        <div class="title">
                            <h4>Sedan</h4>
                        </div>
                        <div class="curv-butn icon-bg">
                    ...
                    <div class="item"> <img src="{{asset('img/cars/06.jpg')}}" class="img-fluid" alt="">
                        <div class="title">
                            <h4>Small Cars</h4>
                        </div>
                        <div class="curv-butn icon-bg">
...
<!-- Video -->
<section class="video-wrapper video section-padding bg-img bg-fixed" data-overlay-dark="4" data-background="{{ asset('img/slider/1.jpg')}}">
    <div class="container">
        <div class="row">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        ...
                        <div class="info mt-30">
                            <div class="img-curv">
                                <div class="img"> <img src="{{ asset('img/team/1.jpg')}}" alt=""> </div>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#ffffff"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="info mt-30">
                            <div class="img-curv">
                                <div class="img"> <img src="{{ asset('img/team/4.jpg')}}" alt=""> </div>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#ffffff"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="info mt-30">
                            <div class="img-curv">
                                <div class="img"> <img src="{{ asset('img/team/6.jpg')}}" alt=""> </div>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#ffffff"></path>
                                    </svg>
...
<section class="blog2 section-padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel owl-theme">
                    <div class="item"> <img src="{{ asset('img/blog/3.jpg')}}" class="img-fluid" alt="">
                    ...
                    <div class="item"> <img src="{{ asset('img/blog/4.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                            <h6>Sport Cars</h6>
                    ...
                    <div class="item"> <img src="{{ asset('img/blog/5.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                            <h6>Fines</h6>
                    ...
                    <div class="item"> <img src="{{ asset('img/blog/6.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                            <h6>Airport</h6>
                    ...
                    <div class="item"> <img src="{{ asset('img/blog/7.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                            <h6>Rules</h6>
                    ...
                    <div class="item"> <img src="{{ asset('img/blog/8.jpg')}}" class="img-fluid" alt="">
                        <div class="bottom-fade"></div>
                        <div class="title">
                            <h6>Rental Car</h6>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/2.png')}}" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/3.png')}}" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/4.png')}}" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/5.png')}}" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/6.png')}}" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/7.png')}}" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img src="{{ asset('img/clients/8.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#exampleModal').on('shown.bs.modal', function() {
            console.log('Modal is open for car ID:', selectedCarId);
