            ...
            <div class="row">
                <div class="col-lg-5 col-md-12">
                    ...
                    <div class="wrapper">
                        <div class="cont">
                            <div class="coll">
                                <div class="social-icon"> <a href="index-2.html"><i class="fa-brands fa-facebook-f"></i></a> <a href="index-2.html"><i class="fa-brands fa-youtube"></i></a> <a href="index-2.html"><i class="fa-brands fa-instagram"></i></a> <a href="index-2.html"><i class="fa-brands fa-whatsapp"></i></a> </div>
                            </div>
                        </div>
                        <div class="cont">
                            <div class="coll">
                                <p>My e-mail address: <a href="mailto:info@renax.com">info@renax.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 offset-lg-1 col-md-12 cont">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="biography" role="tabpanel" aria-labelledby="vision-tab">
                            <p>Biography utate ons amet ravida haretra nuam the duru miss uctus the drana accumsan justo aliquam sit amet auctor orci done duise the nisan sapien in the miss sapien.</p>
                        </div>
                        <div class="tab-pane fade" id="education" role="tabpanel" aria-labelledby="mission-tab">
                            <p>Education utate ons amet ravida haretra nuam the duru miss uctus the drana accumsan justo aliquam sit amet auctor orci done duise the nisan sapien in the miss sapien.</p>
                        </div>
                        <div class="tab-pane fade" id="awards" role="tabpanel" aria-labelledby="mission-tab">
                            <p>Awards utate ons amet ravida haretra nuam the duru miss uctus the drana accumsan justo aliquam sit amet auctor orci done duise the nisan sapien in the miss sapien.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="img/team/1.jpg" class="img-fluid" alt="">
                            ...
                            <div class="butn icon-bg">
                                <a href="{{route('team_single')}}" class="vid">
